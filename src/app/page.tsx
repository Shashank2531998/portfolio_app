...
function HeroSection() {
  return (
    <section id="home" className="bg-primary/10">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-16 items-center">
          <div className="space-y-4">
            <Badge variant="secondary" className="text-sm">Shashank - Software Engineer</Badge>
    ...
    <section id="experience">
      <div className="container mx-auto px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center space-y-4">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-accent">My Journey</h2>
...
function SkillsSection() {
  return (
    <section id="skills" className="bg-primary/10">
      <div className="container mx-auto px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center space-y-4">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-accent">Skills & Expertise</h2>
          <p className="text-muted-foreground md:text-xl">
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-3">
          {Object.entries(skillsData).map(([category, skills]) => (
            <Card key={category} className="bg-background/80 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-accent flex items-center gap-2"><Code className="w-6 h-6"/> {category}</CardTitle>
              </CardHeader>
              <CardContent>
...
function ProjectsSection() {
  return (
    <section id="projects">
      <div className="container mx-auto px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center space-y-4">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-accent">Featured Projects</h2>
          <p className="text-muted-foreground md:text-xl">
...
function ContactSection() {
  return (
    <section id="contact" className="bg-primary/10">
      <div className="container mx-auto px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center space-y-4">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-accent">Get In Touch</h2>
          <p className="text-muted-foreground md:text-xl">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <a href="mailto:shashank@example.com" className="hover:text-primary">shashank@example.com</a>
              </div>
            </div>
